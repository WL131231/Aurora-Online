...
export class MainScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // (Animals deferred to the 목장 phase. assets/animals/ kept on disk for later.)
  ...
  private updateFarm() {
    ...
    if (changed) this.redrawFarm();
  }

  // Returns true if the player interacted with a farm patch (plant or harvest).
  ...
  private tryHarvest() {
    ...
    // Farm action (plant a seed or harvest a turnip) before harvestables.
    if (this.tryFarmAction()) return;
